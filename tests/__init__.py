...
__author__ = " Walker, Fabian Sinz, Dimitri Yatsenko, Raphael Guzman"
...
def teardown_package():
    ...
    cur = conn_root.query(r'SHOW DATABASES LIKE "{}\_%%"'.format(PREFIX))
    ...
    # Remove S3
    objs = list(
        minioClient.list_objects(S3_CONN_INFO["bucket"], recursive=True)
    )
    objs = [
